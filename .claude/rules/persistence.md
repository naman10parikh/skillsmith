- When the chairman says "change X" or corrects behavior, IMMEDIATELY update ALL of these:
...
- Before compaction: verify all chairman corrections from this session are persisted in ALL 4 places.
